...
class InternationalizationService {
  ...
  Future<String> convertCurrency(double amount, String fromCurrency, String toCurrency) async {
    final doc = await _firestore.collection('exchange_rates').doc('$fromCurrency\_$toCurrency').get();
