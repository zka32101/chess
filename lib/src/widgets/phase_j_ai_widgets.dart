          ...
          child: Column(
            ...
            children: [
              ...
              Row(
                ...
                children: [
                  _buildErrorStat(
                      context, 'Blunders', analysis.blunders, Colors.red),
                  _buildErrorStat(
                      context, 'Mistakes', analysis.mistakes, Colors.orange),
                  _buildErrorStat(context, 'Inaccuracies',
                      analysis.inaccuracies, Colors.yellow),
                ],
              ),
              const SizedBox(height: 16),
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              // Strength areas
              _buildMetricRow(
                  context, 'Tactical Strength', profile.tacticalStrength),
              const SizedBox(height: 8),
              _buildMetricRow(
                  context, 'Strategic Strength', profile.strategicStrength),
              const SizedBox(height: 8),
              _buildMetricRow(
                  context, 'Endgame Strength', profile.endgameStrength),
              const SizedBox(height: 16),
